...
namespace MarchingCubesProject
{
    public abstract class Marching : IMarching
    {
        ...
        /// </summary>
        public abstract void March(float x, float y, float z, float[] cube, IList<Vector3> vertList, IList<int> indexList);

		public abstract void March(float x, float y, float z, float[] cube, float cubeLength, IList<Vector3> vertList, IList<int> indexList);
