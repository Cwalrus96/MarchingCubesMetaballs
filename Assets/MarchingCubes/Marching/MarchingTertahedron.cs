...
namespace MarchingCubesProject
{
    public class MarchingTertrahedron : Marching
    {
        ...
        /// </summary>
        public override void March(float x, float y, float z, float[] cube, IList<Vector3> vertList, IList<int> indexList)
        {
		...
		public override void March(float x, float y, float z, float[] cube, float cubeLength, IList<Vector3> vertList, IList<int> indexList)
		{
			int i, j, vertexInACube;
